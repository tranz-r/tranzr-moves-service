...
namespace TranzrMoves.Infrastructure.Migrations
{
    ...
    [Migration("20260501205808_RemoveQuotesV2RedundantXminColumn")]
    partial class RemoveQuotesV2RedundantXminColumn
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("TranzrMoves.Domain.Entities.AddressV2", b =>
                {
                    ...
                    b.HasIndex("UserId")
                        .HasDatabaseName("IX_AddressesV2_UserId");
            ...
            modelBuilder.Entity("TranzrMoves.Domain.Entities.QuoteV2", b =>
                {
                    ...
                    b.Property<int?>("CustomerSelectedVans")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("TranzrMoves.Domain.Entities.UserV2", b =>
                {
                    ...
                    b.Property<Guid?>("CommercialAddressId")
                        .HasColumnType("uuid");
                    ...
                    b.HasIndex("CommercialAddressId");
            ...
            modelBuilder.Entity("TranzrMoves.Domain.Entities.UserV2", b =>
                {
                    b.HasOne("TranzrMoves.Domain.Entities.AddressV2", "BillingAddress")
                        .WithMany()
                        .HasForeignKey("BillingAddressId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("TranzrMoves.Domain.Entities.AddressV2", "CommercialAddress")
                        .WithMany()
                        .HasForeignKey("CommercialAddressId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("TranzrMoves.Domain.Entities.AddressV2", "ResidentialAddress")
                        .WithMany()
                    ...
                    b.Navigation("CommercialAddress");
