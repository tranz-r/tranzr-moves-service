...
public interface ILegalDocumentRepository
{
    ...
    Task<LegalDocument?> GetCurrentAsync(LegalDocumentType documentType, Instant asOfDate, CancellationToken cancellationToken);
    ...
    Task<ErrorOr<bool>> ExpirePreviousDocumentsAsync(LegalDocumentType documentType, Instant expireAt, CancellationToken cancellationToken);
}
